      ...
      child: Column(
        children: [
          ...
          Card(
            child: SfCartesianChart(
              plotAreaBorderWidth: 0,
              title: const ChartTitle(text: "Cena energie v Kč"),
  ...
  return <ColumnSeries<ChartSampleData, String>>[
    ColumnSeries<ChartSampleData, String>(
      dataSource: <ChartSampleData>[
        ChartSampleData(x: '1/2023', y: random.nextInt(2000) + 6000),
        ChartSampleData(x: '2/2023', y: random.nextInt(2000) + 6000),
        ChartSampleData(x: '3/2023', y: random.nextInt(2000) + 6000),
        ChartSampleData(x: '4/2023', y: random.nextInt(2000) + 6000),
        ChartSampleData(x: '5/2023', y: random.nextInt(2000) + 6000),
        ChartSampleData(x: '6/2023', y: random.nextInt(2000) + 6000),
        ChartSampleData(x: '7/2023', y: random.nextInt(2000) + 6000),
        ChartSampleData(x: '8/2023', y: random.nextInt(2000) + 6000),
        ChartSampleData(x: '9/2023', y: random.nextInt(2000) + 6000),
        ChartSampleData(x: '10/2023', y: random.nextInt(2000) + 6000),
        ChartSampleData(x: '11/2023', y: random.nextInt(2000) + 6000),
        ChartSampleData(x: '12/2023', y: random.nextInt(2000) + 6000),
      ],
